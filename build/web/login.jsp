<%-- 
    Document   : login.jsp
    Created on : Mar 25, 2025, 9:36:41 PM
    Author     : VAN NGUYEN
--%>
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control border-0 border-bottom rounded-0" name="userID" id="email" placeholder="name" required>
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-6">
                                                    <div class="text-end">
                                                        <a href="passWordReset.jsp" class="link-secondary text-decoration-none">Forgot password?</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit" name ="submit">Log in</button>
