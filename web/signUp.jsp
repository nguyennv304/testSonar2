...
<%-- 
    Document   : signUp.jsp
    Created on : Mar 25, 2025, 9:41:17 PM
    Author     : VAN NGUYEN
--%>
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control border-0 border-bottom rounded-0" name="userID" id="firstName" placeholder="First Name" required>
                                                <label for="firstName" class="form-label">User Name</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control border-0 border-bottom rounded-0" name="fullName" id="lastName" placeholder="Last Name" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control border-0 border-bottom rounded-0" name="repassword" id="repassword" value="" placeholder="Password" required>
                                                <label for="repassword" class="form-label">Password Again</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit" name = "submit">Sign up</button>
                                                <input type="hidden" name="service" value="addUser2">
                                            </div>
                                        </div>
                                    </div>
                                </form>
